<template>
  <div class="container">
    <div class="header">
      <mt-header title="订单管理" ref="header" class="header">
    ...
    <!-- <van-tabbar v-model="active" :fixed="false" class="tab_box" @change="tabChange(active)">
      <van-tabbar-item><div class="tab_item">新车</div></van-tabbar-item>
      <van-tabbar-item><div class="tab_item">二手车</div></van-tabbar-item>
      <van-tabbar-item><div class="tab_item">租车</div></van-tabbar-item>
      <van-tabbar-item><div class="tab_item">洗美护</div></van-tabbar-item>
    </van-tabbar> -->
    <div class="content" ref="scrollWrap">
      ...
      >
          ...
          <div v-for="(car, index) in currentList" :key="index">
            <div class="car-list_item van-hairline--bottom" @click="orderDetail(car)">
              ...
              <div class="car-info">
                ...
                <p class="info">{{car.total}}万/<span class="blue">首付{{car.payment}}万</span></p>
        ...
        <!-- :style="{background:OrderStates[car.status].background,opacity:OrderStates[car.status].opacity}" -->
      </quick-loadmore>
