    ...
    <div class="content" ref="scrollWrap">
      ...
      >
        <div class="car-list_box">
          <div class="car-list_item van-hairline--bottom" v-for="(car, index) in currentList" :key="index"   @click="rentCar(car)">
            <div class="car-thumb">
